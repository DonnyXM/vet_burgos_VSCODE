                            ...
                            <div class="col-12 col-md-6 col-xl-4">
                                <div class="card border-0 shadow-sm rounded-4 overflow-hidden h-100 pet-card">
                                    ...
                                    <div class="card-body p-4 text-center">
                                        ...
                                        <a href="index.php?controller=Cliente&action=historial&id=<?php echo $mascota['id_mascota']; ?>" class="btn btn-outline-dark w-100 rounded-pill mt-3">Ver Historial</a>
                                    </div>
                                </div>
                            </div>
