                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0" style="min-width: 600px;">
                            <thead class="table-light">
                                <tr>
                                    <th class="py-3 px-4">Nombre del Paciente</th>
                            ...
                            <tbody>
                                <?php if (empty($pacientes)): ?>
                                    <tr>
                                        <td colspan="4" class="text-center py-5 text-muted">No hay pacientes registrados.</td>
                                    </tr>
                                <?php else: ?>
                                    <?php foreach ($pacientes as $paciente): ?>
                                        <tr>
                                            <td class="py-3 px-4 fw-bold">
                                                <i class="fa-solid fa-paw text-muted me-2"></i>
                                                <?php echo htmlspecialchars($paciente['mascota_nombre']); ?>
                                            </td>
                                            <td>
                                                <span class="badge bg-secondary-subtle text-secondary border border-secondary-subtle px-2 py-1">
                                                    <?php echo htmlspecialchars($paciente['especie']); ?>
                                                </span>
                                            </td>
                                            <td class="text-muted">
                                                <?php echo !empty($paciente['raza']) ? htmlspecialchars($paciente['raza']) : 'No especificada'; ?>
                                            </td>
                                            <td>
                                                <i class="fa-regular fa-user text-muted me-1"></i>
                                                <?php echo htmlspecialchars($paciente['dueno_nombre']); ?>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php endif; ?>
